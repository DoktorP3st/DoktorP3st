...
One-click cleaning · Site whitelist (cookies + localStorage/indexedDB) · Cookie manager · Auto-clean on startup · Backup & Restore
...
### [WaveRouter](https://github.com/Lekarov/WaveRouter) — Game Audio Router

> Automatically routes game audio to Elgato Wave Link on Windows — no manual device switching.

![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white)
![Windows](https://img.shields.io/badge/Windows-0078D6?style=flat-square&logo=windows&logoColor=white)
![Elgato](https://img.shields.io/badge/Elgato-Wave%20Link-DA291C?style=flat-square)

### [MarkerBridge](https://github.com/Lekarov/MarkerBridge) — OBS → Premiere Bridge

> Converts OBS chapter markers into Adobe Premiere Pro markers (FCP7 XML) — GUI + CLI, Windows.

![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white)
![OBS](https://img.shields.io/badge/OBS-Chapters-302E31?style=flat-square&logo=obsstudio&logoColor=white)
![Premiere](https://img.shields.io/badge/Adobe-Premiere%20Pro-9999FF?style=flat-square&logo=adobepremierepro&logoColor=white)

### [G2G-2FA-Generator](https://github.com/Lekarov/G2G-2FA-Generator) — TOTP Code Generator

> Generates live 2FA (TOTP) codes from G2G account export CSVs.

![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white)

---

## Twitch / Streaming — Overlays & Tools

### [Pestovich Overlay Alerts](https://github.com/Lekarov/Pestovich-Overlay-Alerts-V1) — Stream Alerts Widget

> Blood Alerts, Diablo Edition — alert widget for Twitch/OBS/StreamElements.
...
Free StreamElements overlays — chat, camera frame (16:9 and 1:1), OBS ready, no attribution required.
...
### [TAC MP4 Studio](https://github.com/Lekarov/TAC-MP4-Studio) — Reactive Music Video Generator
...
### [DiabloIV Macro](https://github.com/Lekarov/DiabloIV-Macro-ByPestovich) — Game Automation Overlay
